...
/**
 * @brief QNN HTA backend PerfInfrastructure specialization structure.
 ...
 *        Hta PerfInfrastructure.
 */
typedef struct {
    QnnHtaPerfInfrastructure_SetPowerConfigFn_t       setPowerConfig;
} QnnHtaBackend_PerfInfrastructure_t ;

/// QnnHtaBackend_PerfInfrastructure_t initializer macro
#define QNN_HTA_BACKEND_PERF_INFRASTRUCTURE_INIT \
  { NULL /*setPowerConfig*/ }
