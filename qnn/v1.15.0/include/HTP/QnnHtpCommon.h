...
#define QNN_HTP_API_VERSION_MAJOR 3
#define QNN_HTP_API_VERSION_MINOR 10
...
#define QNN_HTP_CONTEXT_BLOB_VERSION_MAJOR 2
#define QNN_HTP_CONTEXT_BLOB_VERSION_MINOR 0
#define QNN_HTP_CONTEXT_BLOB_VERSION_PATCH 0

// HTP Native library version values
#define QNN_HTP_NATIVE_LIB_VERSION_MAJOR 1
#define QNN_HTP_NATIVE_LIB_VERSION_MINOR 0
#define QNN_HTP_NATIVE_LIB_VERSION_PATCH 0
