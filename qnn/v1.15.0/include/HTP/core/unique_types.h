...
#define EXPAND_LAST_16(SIZE, STR)                                              \
    STRINDEX(((SIZE)-0xF), STR), STRINDEX(((SIZE)-0xE), STR),                  \
            STRINDEX(((SIZE)-0xD), STR), STRINDEX(((SIZE)-0xC), STR),          \
            STRINDEX(((SIZE)-0xB), STR), STRINDEX(((SIZE)-0xA), STR),          \
            STRINDEX(((SIZE)-0x9), STR), STRINDEX(((SIZE)-0x8), STR),          \
            STRINDEX(((SIZE)-0x7), STR), STRINDEX(((SIZE)-0x6), STR),          \
            STRINDEX(((SIZE)-0x5), STR), STRINDEX(((SIZE)-0x4), STR),          \
            STRINDEX(((SIZE)-0x3), STR), STRINDEX(((SIZE)-0x2), STR),          \
            STRINDEX(((SIZE)-0x1), STR), STRINDEX(((SIZE)-0x0), STR)
