...
struct op_reg_info_t {
    ...
    SimpleOpFactory simple_op_factory{
            nullptr}; // function pointer for generating SimpleOp's for SimpleOpWrapper's
...
/*
	 ...
	 */
extern OpFactory register_op(opname_tag_t name, OpFactory newop,
                             SimpleOpFactory simop, bool is_external);
...
//
void register_optype_by_factory(OpFactory fp, hnnx::opname_tag_t opname_tag,
                                std::type_info const &typ,
                                const char *type_tag);
void register_optype_by_factory(SimpleOpFactory fp,
                                hnnx::opname_tag_t opname_tag,
                                std::type_info const &typ,
                                const char *type_tag);
