...
struct GraphStatus {
    ...
    enum GraphErrorCode {
        ...
        ErrorBadID =
                9, // source ref was 0 or not defined in graph; node ID was 0 or duplicate.
        ErrorBadInput = 10,
        ErrorInvalidTCM = 11,
        ...
        ErrorFatalCheck =
                15, // preprocess in prepare, e.g. clear the opid_alias_map, check connectivity, order_nodes
        ErrorBadOpName = 16,
        ErrorFatalOptimize = 17,
        ErrorFatalCSE =
                18, // steps that combined with CSE e.g. dead_code_removal_and_cse, const_prop_and_cse()
        ErrorFatalInsert =
                19, // when inject DMA spill/fill to fix any oversubscription of TCM
        ...
        NotApplicable =
                100, // used for internal signaling, should not be returned from API
        Yielding = 101,
        ErrorFatal = -1,
    };
#ifdef __cplusplus
