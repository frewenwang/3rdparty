...
###### Setup Instructions
1. Set QNN_SDK_ROOT by running `source <QNN_SDK_ROOT>/target/x86_64-linux-clang/bin/envsetup.sh`
2. Set HEXAGON_SDK_ROOT by running `source <HEXAGON_SDK_PATH>/setup_sdk_env.source `
3. Ensure ANDROID_NDK_ROOT contains the path of the Android NDK

###### Execution Instructions
1. Run `qnn-op-package-generator -p <QNN_SDK_ROOT>/target/x86_64-linux-clang/examples/OpPackageGenerator/ExampleOpPackageHtp.xml -o <output_dir>`
