...
QNN_NET_RUN=${QNN_SDK_ROOT}/target/x86_64-linux-clang/bin/qnn-net-run
export LD_LIBRARY_PATH=${QNN_SDK_ROOT}/target/x86_64-linux-clang/lib/:${MODEL_LIBS}/x86_64-linux-clang:${LD_LIBRARY_PATH}
