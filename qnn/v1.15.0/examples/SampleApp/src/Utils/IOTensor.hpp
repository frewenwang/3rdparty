...
class IOTensor {
 public:
  ...
  StatusCode writeOutputTensors(uint32_t graphIdx,
                                ...
                                char *graphName,
                                Qnn_Tensor_t *outputs,
                                qnn_wrapper_api::Qnn_TensorWrapper_t *outputInfos,
                                uint32_t numOutputs,
 ...
 private:
  ...
  StatusCode setupTensors(Qnn_Tensor_t **tensors,
                          uint32_t tensorCount,
                          qnn_wrapper_api::Qnn_TensorWrapper_t *tensorsInfo);

  StatusCode deepCopyQnnTensorInfo(Qnn_Tensor_t *dest, Qnn_Tensor_t *src);
