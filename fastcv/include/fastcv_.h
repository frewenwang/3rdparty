...
#include <string.h>
#ifdef __WOA__
     #define FASTCV_MEMCPY( dest,src,count )(memcpy_s(dest, count, src, count))
#else
     #define FASTCV_MEMCPY( dest,src,count )(memcpy(dest,src,count/*,count*/))
#endif
//==============================================================================
// Included modules
//==============================================================================
...
//------------------------------------------------------------------------------
/// @brief
///    Global identifiers for ADSP, CDSP and MDSP.
//------------------------------------------------------------------------------

typedef enum
{
    QDSP_ADSP = 0,
    // To identify ADSP unit for multi-domains

    QDSP_CDSP,
    // To identify CDSP unit for multi-domains

    QDSP_MDSP,
    // To identify MDSP unit for multi-domains

} FASTCV_QDSP_DOMAINS;

//------------------------------------------------------------------------------
/// @brief
///    Operation mode global variable.
//------------------------------------------------------------------------------
extern fcvOperationMode mode_globalVar;
...
int fcvSetOperationMode_internal( fcvOperationMode mode );
#ifdef __cplusplus
}
#endif
